...
[void]$R.Add("  WriteCanonVector '0002_string_escapes' '{""s"":""a\\""b\\\\c\\n""}' '{""s"":""a\\""b\\\\c\\u000a""}' '# 0002_string_escapes`nEscapes: quote, backslash, newline via \\n -> canon \\u000a.`n'")
